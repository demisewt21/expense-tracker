...
import { login } from '../services/authService';   // ←←← THIS IS THE ONLY NEW IMPORT
...
const Login = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.location.href = '/dashboard';   // ← redirects to your dashboard (change only if your route is different)
